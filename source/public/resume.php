...
<html lang="en">
  <head>
    ...
    <link href='https://fonts.googleapis.com/css?family=Open+Sans:400italic,400|EB+Garamond|Alegreya+Sans+SC:300,400' rel='stylesheet' type='text/css'>
    <link href='resume.css' rel='stylesheet' type='text/css'>
    <title>Resume - David Aaron Suddjian</title>
  </head>
  <body>
    <div class="wrapper">
      <h1 class="page-title">David Aaron Suddjian</h1>
      <header class="personal-info">
        <h2>Personal Data</h2>
        <dl>
          <dt class="website">Website</dt>
          <dd><a href="http://digitalrocketry.com">digitalrocketry.com</a></dd>
          <dt class="email">Email</dt>
          <dd><a href="mailto:aaron@digitalrocketry.com">aaron@digitalrocketry.com</a></dd>
